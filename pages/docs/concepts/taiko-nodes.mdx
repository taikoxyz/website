...
- Read more about block metadata [here](https://taiko.xyz/docs/concepts/creating-taiko-blocks/intrinsic-validity-functions).
- Read more about `txList` validation rules [here](https://taiko.xyz/docs/concepts/creating-taiko-blocks/intrinsic-validity-functions).
- Read more about the `TaikoL2.anchor` transaction and proposed block's determination [here](https://taiko.xyz/docs/concepts/proposing#anchor-transaction).
