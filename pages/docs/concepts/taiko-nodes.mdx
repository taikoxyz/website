...
If the `txList` is **invalid**, the driver assembles an empty L2 block with only the anchor transaction.

You can see more detailed information about proposed blocks [here](https://taiko.xyz/docs/concepts/proposing).
