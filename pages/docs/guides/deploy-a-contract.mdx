...
<Tabs items={["Remix", "Foundry", "Hardhat", "Thirdweb"]} defaultIndex="0">
  ...
  <Tab>
      **1. Deploy your smart contract using Thirdweb**
      ...
      ![Deploy interface](public/images/guides/deploy-thirdweb/thirdweb2.png)
      ...
      **2. Dashboard interface**
      ...
      ![Deploy interface](public/images/guides/deploy-thirdweb/thirdweb-message.png)

      Now your contract is deployed on the Taiko Jolnir L2.

      ![Deploy interface](public/images/guides/deploy-thirdweb/thirdweb-dashboard.png)
