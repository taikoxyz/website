...
<Tabs items={["Remix", "Foundry", "Hardhat", "Thirdweb"]} defaultIndex="0">
  ...
  <Tab>
      **1. Deploy your smart contract using Thirdweb**
      ...
      Step 1: Initialize the Node.js project Use npm or yarn to initialize a Node.js project. We recommend npm 7 or later. Run the following commands in the terminal :
      
      ```bash
      npm init -y
      ```

      Step 2: Installing Hardhat Install Hardhat as a development dependency in your project with the following command :

      ```bash
      npm install --save-dev hardhat
      ```

      Step 3: Initializing the Hardhat project Run the following command to create a Hardhat project with minimal configuration :
      
      ```bash
      npx hardhat init
      ```

      You'll be presented with a menu allowing you to choose various options. Choose "Create a JavaScript project". Hardhat will automatically create a default project configuration in a hardhat.config.js file.
      ...
      **2. Dashboard interface**
      ...
      ![Deploy interface](/images/guides/deploy-thirdweb/thirdweb-transaction.png)
      ...
      ![Deploy interface](/images/guides/deploy-thirdweb/thirdweb-message.png)

      Now your contract is deployed on the Taiko Jolnir L2.

      ![Deploy interface](/images/guides/deploy-thirdweb/thirdweb-dashboard.png)
