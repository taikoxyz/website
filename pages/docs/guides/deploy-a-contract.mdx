...
<Tabs items={["Remix", "Foundry", "Hardhat", "Thirdweb"]} defaultIndex="0">
  ...
  <Tab>
      **1. Deploy your smart contract using Thirdweb**
      ...
      ![Deploy interface](/public/images/guides/deploy-thirdweb/thirdweb1.png)
      ...
      ![Deploy interface](/public/images/guides/deploy-thirdweb/thirdweb3.png)
      ...
      **2. Dashboard interface**
      ...
      ![Deploy interface](/public/images/guides/deploy-thirdweb/thirdweb4.png)
      ...
      ![Deploy interface](/public/images/guides/deploy-thirdweb/thirdweb-deploy.png)
      ...
      ![Deploy interface](/public/images/guides/deploy-thirdweb/thirdweb-transaction.png)
